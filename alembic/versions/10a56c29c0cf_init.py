...
Revision ID: 10a56c29c0cf
Revises: 
Create Date: 2025-06-28 04:46:18.706079
...
def upgrade() -> None:
    ...
    sa.Column('translate', sa.ARRAY(sa.String(length=255)), nullable=False),
